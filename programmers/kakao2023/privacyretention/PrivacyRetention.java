...
public class PrivacyRetention {
    ...
    public int[] solution(String today, String[] terms, String[] privacies) {
        ...
        for (String t : terms) {
            ...
            termMonths.put(parts[0], Integer.parseInt(parts[1]));
        }
        ...
        for (int i = 0; i < privacies.length; i++) {
            ...
            int startDays = toDays(collectedDate);
            int months = termMonths.get(termKey);

            int destroyStart = startDays + months * 28;

            if (destroyStart <= todayDays) {
                ans.add(i + 1);
            }
        }
